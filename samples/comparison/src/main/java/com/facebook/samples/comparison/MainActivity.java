...
//            String str = Arrays.toString(buf);
        ...
        ImageView iv_test_picasso = (ImageView) findViewById(R.id.iv_test_picasso);
        Picasso.with(this).load(R.drawable.test).into(iv_test_picasso);*/
        ...
        ImageUrlsFetcher.getImageUrls(
                ...
                new ImageUrlsFetcher.Callback() {
                    ...
                    public void onFinish(List<String> result) {
                        ...
                        mImageUrls.add("http://img.17u.cn/ly/cn/img/admin/Cruises/doc/2016/3/21/8f4ba7d580754f5b918ed6eb5a54739b.jpg");
                        mImageUrls.add("http://img.17u.cn/ly/cn/img/admin/Cruises/doc/2016/3/21/7d786bada1d64d6ea1dc5a016a949816.jpg");
                        updateAdapter(mImageUrls);
                    }
                });
    }
